Tourism Guide – Fars Province (C# / WinForms)
📌 Description
...
Images + descriptions of popular places in Fars

Clean, readable C# code suitable for educational use
...
MenuStrip displays categories of attractions
...
Clean UI design aligned with educational project requirements

Organizes information in separate forms to improve structure

Includes real-world, verified information about Fars Province attractions
